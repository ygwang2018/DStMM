...
run_simulation_grid(
  grid = experiment1_robustness_grid(), experiment_name = "Experiment1Robustness",
  output_file = file.path(root, "results", "experiment1_robustness_raw.csv"),
  n_replications = N_REP, max_iter = MAX_ITER, eps = EPS,
  min_iter = MIN_ITER, moving_window = WINDOW, M = M,
  base_data_seed = 120000L, base_fit_seed = 320000L,
