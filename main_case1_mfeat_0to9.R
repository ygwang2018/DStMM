...
#   * Table 1 includes >= 8 genuine comparison methods in paper mode, including
#     a direct skew-t factor-analyzer competitor: uMSTFA (uskewFactors).
#
# UCI data ordering
...
RESULT_DIR <- file.path(PROJECT_ROOT, "results", "case1_mfeat_fac_digits_0_to_9")
...
cat("\nFor the final manuscript run set RUN_MODE='paper'.\n")
cat("For slow factor/skew-t competitors, also set RUN_FACTOR_BASELINES=TRUE\n")
cat("and RUN_SLOW_SKEWT_BASELINES=TRUE.\n")
